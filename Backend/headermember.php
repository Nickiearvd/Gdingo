		...
		<header id= "header">
			...
			<nav class="nav">
				<ul>
					...
					<li><a class="<?php echo $current_page == '../index.php' ? 'active' : NULL ?>" href="../index.php">Inspo</a></li>
					<li><a class="<?php echo $current_page == '../index.php' ? 'active' : NULL ?>" href="../index.php">About us</a></li>
				</ul>
			</nav>
